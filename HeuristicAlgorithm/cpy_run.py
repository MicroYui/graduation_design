...
from scale_min import environment_min as environment1
from scale_7_7 import environment_7services_7nodes as environment2
from scale_mid import environment_mid as environment3
from scale_12_12 import environment_12services_12nodes as environment4
from scale_max import environment_max as environment5


# from PPO.generate import get_state_list
...
if __name__ == '__main__':
    ...
    state = torch.tensor(
        [0.0000, 1.0000, 0.0000, 1.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
         1.0000, 1.0000, 0.0000, 0.0000, 0.0000, 1.0000, 1.0000, 0.0000, 0.0000,
         1.0000, 1.0000, 0.0000, 1.0000, 0.0000, 0.0000, 0.0000, 0.0000, 1.0000,
         1.0000, 1.0000, 0.0000, 0.0000, 1.0000, 0.0000, 1.0000, 0.0000, 0.0000,
         1.0000, 1.0000, 0.0000, 1.0000, 1.0000, 0.0000, 1.0000, 0.0000, 0.0000,
         1.0000, 0.0000, 0.0000, 1.0000, 0.0000, 1.0000, 1.0000, 1.0000, 0.0000,
         0.0000, 0.0000, 0.0000, 1.0000, 0.0000, 0.0000, 1.0000, 1.0000, 1.0000,
         ...
         1.0000, 0.0000, 0.0000, 0.0000, 1.0000, 1.0000, 0.0000, 1.0000, 0.0000,
         0.0000, 0.0000, 0.0000, 1.0000, 1.0000, 1.0000, 0.0000, 1.0000, 0.0000,
         ...
         0.8500, 1.0000, 1.0000, 1.0000, 0.0500]
    )
    # print(torch.tensor(state))
    # my_ga(environment, state)
