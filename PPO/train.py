...
def train():
    ...
    max_training_timesteps = int(7e6)  # break training loop if timeteps > max_training_timesteps
    ...
    s = torch.tensor([0.0000, 1.0000, 1.0000, 0.0000, 0.0000, 1.0000, 1.0000, 0.0000, 1.0000,
